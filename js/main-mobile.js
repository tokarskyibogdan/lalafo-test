...
jQuery(function ($) {
    ...
    $('.btn-add-phone-number').click(function(e){
        e.preventDefault();
        phoneNumberId++;
        $('.phones-section').append('<div class="row no-gutters phone-section"><div class="col-12"><select name="phone-code" id="phone-code"><option value="+380">+380</option><option value="+280">+280</option><option value="+180">+180</option></select><input type="number" id="phone-number" placeholder="+______________________"></div><div class="col-12"><ul class="number-connect"><li><label for="Whatsapp['+ phoneNumberId +']">Whatsapp</label><div class="checkbox-item"><input type="checkbox" value="Whatsapp['+ phoneNumberId +']" id="Whatsapp['+ phoneNumberId +']" name="check" checked /><label for="Whatsapp['+ phoneNumberId +']"></label></div></li><li><label for="Viber['+ phoneNumberId +']">Viber</label><div class="checkbox-item"><input type="checkbox" value="Viber['+ phoneNumberId +']" id="Viber['+ phoneNumberId +']" name="check" /><label for="Viber['+ phoneNumberId +']"></label></div></li><li class="delete-phone-number text-danger">Delete</li></ul></div></div>');
    });
